...
export const getListTeamAssignmentsUrl = () => {
 ...
 */
export const listTeamAssignments = async ( options?: RequestInit): Promise<TeamAssignmentsEnvelope> => {

  return customFetch<TeamAssignmentsEnvelope>(getListTeamAssignmentsUrl(),
  {
    ...options,
    method: 'GET'
...
export const getListTeamAssignmentsQueryKey = () => {
    return [
...
export const getListTeamAssignmentsQueryOptions = <TData = Awaited<ReturnType<typeof listTeamAssignments>>, TError = ErrorType<ErrorEnvelope>>( options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof listTeamAssignments>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
) => {

const {query: queryOptions, request: requestOptions} = options ?? {};

  const queryKey =  queryOptions?.queryKey ?? getListTeamAssignmentsQueryKey();



    const queryFn: QueryFunction<Awaited<ReturnType<typeof listTeamAssignments>>> = ({ signal }) => listTeamAssignments({ signal, ...requestOptions });





   return  { queryKey, queryFn, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof listTeamAssignments>>, TError, TData> & { queryKey: QueryKey }
}

export type ListTeamAssignmentsQueryResult = NonNullable<Awaited<ReturnType<typeof listTeamAssignments>>>
export type ListTeamAssignmentsQueryError = ErrorType<ErrorEnvelope>
...
export function useListTeamAssignments<TData = Awaited<ReturnType<typeof listTeamAssignments>>, TError = ErrorType<ErrorEnvelope>>(
  options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof listTeamAssignments>>, TError, TData>, request?: SecondParameter<typeof customFetch>}

 ):  UseQueryResult<TData, TError> & { queryKey: QueryKey } {

  const queryOptions = getListTeamAssignmentsQueryOptions(options)
 ...
 */
export const listAllUsers = async ( options?: RequestInit): Promise<AdminUsersEnvelope> => {

  return customFetch<AdminUsersEnvelope>(getListAllUsersUrl(),
  {
    ...options,
    method: 'GET'
...
export const getListAllUsersQueryOptions = <TData = Awaited<ReturnType<typeof listAllUsers>>, TError = ErrorType<ErrorEnvelope>>( options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof listAllUsers>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
) => {
...
export function useListAllUsers<TData = Awaited<ReturnType<typeof listAllUsers>>, TError = ErrorType<ErrorEnvelope>>(
...
export const updateUserRole = async (userId: string,
    updateUserRoleInput: UpdateUserRoleInput, options?: RequestInit): Promise<AdminUserEnvelope> => {

  return customFetch<AdminUserEnvelope>(getUpdateUserRoleUrl(userId),
  {
    ...options,
    method: 'PATCH',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
